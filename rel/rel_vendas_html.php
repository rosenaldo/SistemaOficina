...
<body>
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <h1 class="document-title">Relatório de Vendas</h1>
            </div>
        ...
        <table class="sales-table">
            ...
            <tbody>
                ...
                for ($i=0; $i < @count($res); $i++) { 
                    ...
                    $nome_funcionario = !empty($res_usu[0]['nome']) ? $res_usu[0]['nome'] : 'Não informado';
                ...
                <tr>
                    ...
                    <td class="text-right currency">R$ <?php echo $valorF ?></td>
        ...
        <div class="total-box">
            <div class="row">
                <div class="col-md-12 text-right">
                    ...
                    <span class="info-value">R$ <?php echo number_format($saldo, 2, ',', '.') ?></span>
                </div>
            </div>
        </div>
