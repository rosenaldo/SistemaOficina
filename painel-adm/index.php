...
$email_usu = @$res[0]['email'];
    ...
    $menu13 = "clientes";
    $menu14 = "veiculos"; 
    $menu15 = "aprovar_orcamentos";
    $menu16 = "ordem_servico"; 
    $menu17 = "plano_manutencao";
    $menu18 = "cadastrar_manutencao"; 
    // $menu19 = "controles";
    // $menu20 = "retornos";
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseManutencao" class="collapse" aria-labelledby="headingManutencao" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu18 ?>">Cadastrar PCM</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu17 ?>">Gerar PCM</a>
...
<!-- -----------------------------------------------  -->
                ...
                <li class="nav-item">
                    ...
                    <i class="fas fa-paste fa-chart-area"></i>
                    <span class="">Ordem de Serviço</span></a>
                </li>
