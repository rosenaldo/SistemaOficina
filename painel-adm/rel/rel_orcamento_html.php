    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6" style="width:50%; float:left;">
                <p style="font-size:13px"> <b>Valor Serviços: </b> R$
                    <?php echo number_format($total_ser, 2, ',', '.') ?> </p>
                <p style="font-size:13px"> <b>Valor Peças / Produtos: </b> R$
                    <?php echo number_format($total_prod, 2, ',', '.') ?> </p>
            ...
            <div class="col-md-4 areaTotal" align="right" style="width:40%; float:right;">
                ...
                <p class="pgto" style="font-size:12px"> Orçamento válido até:
                    <?php echo date('d/m/Y', strtotime("+$validade_orcamento_dias days",strtotime($data_orc)));  ?> </p>
            </div>
